...
$_LANG['domaindnsmxonly'] = "Prioritás Rekord MX csak";
...
$_LANG['domainaddonscancelareyousure'] = "Biztos benne, hogy le szeretné tiltani és törölni ezt a domain kiegészítést?";
$_LANG['domainaddonsconfirm'] = "Erősítse meg a Lemondást";
$_LANG['domainaddonscancelsuccess'] = "Kiegészítés Deaktiválva Sikeresen!";
...
$_LANG['domainCheckerSalesGroup']['sale'] = "Eladás";
$_LANG['domainCheckerSalesGroup']['hot'] = "Hot";
$_LANG['domainCheckerSalesGroup']['new'] = "Új";

$_LANG['pricing']['browseExtByCategory'] = "Bővítmények tallózása kategóriák szerint";
$_LANG['pricing']['register'] = "Új Ár";
$_LANG['pricing']['transfer'] = "Transzfer";
$_LANG['pricing']['renewal'] = "Megújítás";
$_LANG['pricing']['selectExtCategory'] = "Kérjük, válasszon egy kategóriát a fentiekből.";

$_LANG['navStore'] = "Áruház";
$_LANG['navBrowseProductsServices'] = "Összes tallózása";
...
$_LANG['store']['configure']['configureProduct'] = "A termék konfigurálása";

$_LANG['store']['ssl']['dv']['tagline'] = "Biztosítsa webhelyét mindössze néhány perc alatt!";
$_LANG['store']['ssl']['dv']['descriptionTitle'] = "Mi az a Standard DV SSL?";
$_LANG['store']['ssl']['dv']['descriptionContent'] = "<p>A domain érvényesítési tanúsítványok gazdaságos és gyors módszert kínálnak az SSL-nek az Ön webhelyére történő bevezetésére. Domain Validált tanúsítványok igazolják, hogy a domain tulajdonosa, de nem végez további szervezeti szintű érvényesítést.</p><p>Domain Validált tanúsítványok ideálisak személyes webhelyekhez, blogokhoz és közösségi médiához, vagy olyan webhelyekhez, amelyek nem adnak privát és bizalmas információkat. A domain validált tanúsítvány aktiválja a böngésző lakatot, és lehetővé teszi a https használatát annak biztosítása érdekében, hogy webhelye látogatói és ügyfelei komolyan vegyék figyelembe az adatvédelmet.</p>";

$_LANG['store']['ssl']['ov']['tagline'] = "A nagy biztonságú SSL a webhely látogatóinak hitelesített azonosságát mutatja";
$_LANG['store']['ssl']['ov']['descriptionTitle'] = "Mi az SSL Szervezeti Érvényesítése?";
$_LANG['store']['ssl']['ov']['descriptionContent'] = "<p>A Szervezet Érvényesített SSL-tanúsítványai azonnali azonosítási megerősítést és erős SSL-védelmet nyújtanak webhelye és üzleti tevékenysége számára.</p><p>Az OV SSL egy szervezet által hitelesített tanúsítvány, amely növeli a webhely hitelességét a tartományvezérelt SSL tanúsítványokon. Aktiválja a böngésző lakatot és https-et, bemutatja vállalati identitását, és biztosítja ügyfeleinek, hogy nagyon komolyan veszi a biztonságot. A webhely látogatói ellenőrizhetik, hogy a webhelyet törvényes cég működteti-e, és nem egy szabályozó webhely.</p>";

$_LANG['store']['ssl']['ev']['tagline'] = "Aktiválja a zöld címsorot a legmagasabb bizalomra és konverziókra";
$_LANG['store']['ssl']['ev']['descriptionTitle'] = "Mit jelent a Kiterjesztett Érvényesítés SSL?";
$_LANG['store']['ssl']['ev']['descriptionContent'] = "<p>Az EV SSL egy kiterjesztett érvényesítési tanúsítvány, a ma elérhető legmagasabb SSL-osztály, és nagyobb hitelességet és megbízhatóságot biztosít a webhelyére, mint egy szervezet vagy tartomány által hitelesített SSL tanúsítvány.</p><p>Kiterjesztett érvényesítés Az SSL aktiválja a zöld címsávot, és megjeleníti a vállalat vagy szervezet nevét a böngésző címsorában. Ezek a kiemelkedő vizuális biztonsági mutatók lehetővé teszik a látogatók számára, hogy további lépéseket tesznek annak érdekében, hogy megerősítsék az általuk látogatott webhelyet, növelve a felhasználók bizalmát a webhelyén és hitelességét - ezért a legtöbb nagyvállalat és szervezet választja ki az EV tanúsítványokat.</p>";

$_LANG['store']['ssl']['wildcard']['tagline'] = "Biztonságos korlátlan aldomaineket egyetlen tanúsítványon.";
$_LANG['store']['ssl']['wildcard']['descriptionTitle'] = "Mi az a Wildcard SSL tanúsítvány?";
$_LANG['store']['ssl']['wildcard']['descriptionContent'] = "<p>A Wildcard SSL lehetővé teszi, hogy korlátlan számú aldomainet biztosítson egyetlen tanúsítványon. Ez egy nagyszerű megoldás mindazoknak, akik ugyanazon a domainen több webhelyet vagy oldalt tárolnak vagy kezelnek. A tanúsítvány egyszeri költsége kiterjed a további aldomainekre, amelyeket a jövőben hozzáadhat.</p><p>Szabványos SSL tanúsítvánnyal ellentétben, amely csak egyetlen teljesen minősített domainnévre vonatkozik, pl. www.yourdomain.com, ami azt jelenti, hogy csak arra használható, hogy biztosítsa a pontos domaint, amelyre kiadták, egy Wildcard SSL tanúsítványt ad ki a * .yourdomain.com címre, ahol a csillag az összes lehetséges aldomainet ábrázolja.</p><p>A Wildcard SSL egy opció DV és OV SSL tanúsítványok számára.</p>";
...
$_LANG['invoicesPaymentPending'] = "Fizetés Függőben";

$_LANG['ssl']['changeApproverEmail'] = "Módosítsa az engedélyező e-mailt";
$_LANG['ssl']['reissueCertificate'] = "Tanúsítvány Újrakiadása";
$_LANG['ssl']['retrieveCertificate'] = "Tanúsítvány Lekérése";

$_LANG['upgradeCredit'] = "Frissítés Hitel";
